...
**`rig` only** — desktop. Differing dotfiles (gitconfig, fish, GTK, COSMIC panel/dock/shortcuts)
are `.tmpl` files switching on hostname; `home/.chezmoiignore` limits the cf-ddns and
career-ops user services + scripts to rig.
